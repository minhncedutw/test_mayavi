...
def visualize_different_color():
    ...
    pts = mlab.quiver3d(x, y, z, ones, ones, ones, scalars=scalars, mode='sphere')  # Create points
...
def custom_visulatilation():
    def standard_color(transparent=255):
        colors = np.array([COLOR_BLACK, COLOR_RED, COLOR_GREEN, COLOR_BLUE, COLOR_YELLOW, COLOR_PINK, COLOR_CYAN, COLOR_WHITE])
